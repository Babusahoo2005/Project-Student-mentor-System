 ...
 * @author lenovo
 */
public class registerform03 extends javax.swing.JFrame {

    /**
     * Creates new form registerform03
     */
    public registerform03() {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            int  rs = stmt.executeUpdate("INSERT INTO adminregister VALUES ('" + s1 + "', '" + s2 + "', '" + s3 + "', '" + s4 + "', '" + s5 + "')");
            if (rs > 0) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(registerform03.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new registerform03().setVisible(true);
            }
        });
    }
